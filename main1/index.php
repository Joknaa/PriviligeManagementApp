                ...
                <div class="row"> 
                    ...
                    <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
                        <div class="bg-light d-block mt-sm-5 pb-5 ps-4 pe-4 pt-5 shadow">
                            ...
                            <h4 class="fw-bold h5 text-dark">Gestion des notes des étudiants</h4> 
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p>
                            <a href="#" class="text-decoration-none">Learn More</a> 
                        </div>                         
                    </div>
                    <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
                        <div class="bg-light d-block mb-sm-n5 mt-sm-5 pb-5 ps-4 pe-4 pt-5 shadow">
                            ...
                            <h4 class="fw-bold h5 text-dark">Calendrier des réunions</h4> 
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p>
                            <a href="#" class="text-decoration-none">Learn More</a> 
                        </div>                         
                    </div>
                    <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
                        <div style="margin-top:48px" class="bg-light d-block pb-5 ps-4 pe-4 pt-5 shadow">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="2.5em" height="2.5em" class="mb-3 text-primary">
                                <g>
                                    <path fill="none" d="M0 0h24v24H0z"></path>
                                    <path fill-rule="nonzero" d="M11 9h10a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H11a1 1 0 0 1-1-1V10a1 1 0 0 1 1-1zm1 2v8h8v-8h-8zm-6-.414l1.828-1.829 1.415 1.415L5 14.414.757 10.172l1.415-1.415L4 10.586V8a5 5 0 0 1 5-5h4v2H9a3 3 0 0 0-3 3v2.586z"></path>
                                </g>
                            </svg>                             
                            <h4 class="fw-bold h5 text-dark">Dépot de cours&nbsp;</h4> 
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p>
                            <a href="#" class="text-decoration-none">Learn More</a> 
                        </div>
                    </div>
                ...
                <div class="row"> 
                    <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
                        <div style="margin-top:48px" class="bg-light d-block pb-5 ps-4 pe-4 pt-5 shadow">
                            ...
                            <h4 class="fw-bold h5 text-dark">Gestion des réunions</h4> 
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p>
                            <a href="#" class="text-decoration-none">Learn More</a> 
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
                        <div class="bg-light d-block mb-sm-n5 mt-sm-5 pb-5 ps-4 pe-4 pt-5 shadow">
                            ...
                            <h4 class="fw-bold h5 text-dark">Gestion des étudiants</h4> 
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p>
                            <a href="#" class="text-decoration-none">Learn More</a> 
                        </div>                         
                    </div>
                ...
                <div class="row"> 
                    ...
                    <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
                        <div class="bg-light d-block mt-sm-5 pb-5 ps-4 pe-4 pt-5 shadow">
                            ...
                            <h4 class="fw-bold h5 text-dark">Gestion des départements</h4> 
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p>
                            <a href="#" class="text-decoration-none">Learn More</a> 
                        </div>                         
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
                        <div style="margin-top:48px" class="bg-light d-block pb-5 ps-4 pe-4 pt-5 shadow">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="2.5em" height="2.5em" class="mb-3 text-primary">
                                <g>
                                    <path fill="none" d="M0 0h24v24H0z"></path>
                                    <path fill-rule="nonzero" d="M6 10v10h13V10H6zm12-2h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1h2V7a6 6 0 1 1 12 0v1zm-2 0V7a4 4 0 1 0-8 0v1h8zm-9 3h2v2H7v-2zm0 3h2v2H7v-2zm0 3h2v2H7v-2z"></path>
                                </g>
                            </svg>                             
                            <h4 class="fw-bold h5 text-dark">Gestion des privilèges</h4> 
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p>
                            <a href="#" class="text-decoration-none">Learn More</a> 
                        </div>
                    </div>
                        ...
                        <div id="carousel2" class="carousel slide" data-bs-ride="carousel"> 
                            <div class="carousel-inner"> 
                                <div class="carousel-item active"> 
                                    ...
                                    <h2 class="mb-3">Nous avons tendance à mesurer la réussite à l&rsquo;importance de notre salaire ou à la grosseur de nos voitures plutôt qu&rsquo;aux liens que nous cultivons avec les autres.</h2> 
                                    <div class=""> 
                                ...
                                <div class="carousel-item"> 
                                    ...
                                    <h2 class="mb-3">Le succès c&apos;est d&apos;aller d&apos;échec en échec sans perdre d&apos;enthousiasme.</h2> 
                                    <div class=""> 
                                ...
                                <div class="carousel-item"> 
                                    ...
                                    <h2 class="mb-3">La difficulté ou l&rsquo;obscurité d&rsquo;un sujet n&rsquo;est pas une raison suffisante pour le négliger.</h2> 
                                    <div class=""> 
