                ...
                <div id="carousel2" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <h2 class="mb-3">Nous avons tendance à mesurer la réussite à l&rsquo;importance de notre
                                salaire ou à la grosseur de nos voitures plutôt qu&rsquo;aux liens que nous cultivons
                                avec les autres.</h2>
                            <div class="">
                        ...
                        <div class="carousel-item">
                            ...
                            <h2 class="mb-3">La difficulté ou l&rsquo;obscurité d&rsquo;un sujet n&rsquo;est pas une
                                raison suffisante pour le négliger.</h2>
                            <div class="">
        ...
        <div class="row">
            <div class="col-xl-12 me-auto py-3">
                <a href="#" class="d-inline-block fw-bold h2 link-light mb-4 text-decoration-none text-uppercase"
                   target>Ensa tétouan</a>
                <p class="mb-3">Créée en septembre 2008, l&rsquo;Ecole Nationale des Sciences Appliquées de Tétouan est
                    un établissement public à caractère scientifique, culturel et professionnel, instaurée pour être une
                    école d&rsquo;ingénieurs de haut niveau.</p>
                <div class="mb-4">
